...
1. List numbers
2. Go through each number one at a time
3. When compared, move larger number to back of list
4 Repeat until all numbers are ordered from smallest to largests
