document.addEventListener('DOMContentLoaded', function() {
  var typed = new Typed('#typed', {
    strings: ['', 'creative', 'intuitive','tenacious', 'musical', 'intellectual', 'optimistic', `realistic`,'strong', 'friendly', 'empathetic', 'attentive', 'poised', 'thoughtful', 'driven', 'me'],
    typeSpeed: 50,
    backSpeed: 20,
    startDelay: 2000,
    loop: false,
  ...
  var typed2 = new Typed('#typed2', {
    strings: ['', 'I am: creative', 'I am: poised', 'I am: intellectual', 'I am: silly', 'I am: strong', 'I am: friendly', 'I am: empathetic', 'I am: attentive', 'I am: intuitive', 'I am: musical', 'I am: thoughtful', 'I am: driven', 'I am: tenacious'],
    typeSpeed: 40,
    backSpeed: 0,
    fadeOut: true,
    loop: true
...
/*'About Me', 'I am: creative', 'I am: poised', 'I am: intellectual', 'I am: silly', 'I am: strong', 'I am: friendly', 'I am: empathetic', 'I am: attentive', 'I am: intuitive', 'I am: musical', 'I am: thoughtful', 'I am: driven', 'I am: tenacious'*/
...
document.addEventListener("keydown", docHandleKeydown, !0), document.addEventListener("keyup", docHandleKeyup, !0), document.addEventListener("focus", docHandleFocus, !0), document.addEventListener("blur", docHandleBlur, !0), M.initializeJqueryWrapper = function(n, s, o) {
    ...
    var e = t || document.body,
        i = {
            ...
            Carousel1: e.querySelectorAll(".carousel1:not(.no-autoinit)"),
...
M.anime = function() {
                ...
                return _inherits(n, Component), _createClass(n, [{
                    ...
                    value: function(t) {
                        ...
                        if (n.length && n.parent().hasClass("tab"))
                            ...
                            var o = this.index;
                            this.index = Math.max(this.$tabLinks.index(n), 0), this.options.swipeable ? this._tabsCarousel1 && this._tabsCarousel1.set(this.index, function() {
                    ...
                    value: function() {
                        ...
                        this.$tabLinks.each(function(t) {
                            ...
                            e.addClass("carousel1-item"), n = n.add(e)
                        });
                        var t = a('<div class="tabs-content carousel1 carousel1-slider"></div>');
                        n.first().before(t), t.append(n), n[0].style.display = "";
                        var e = this.$activeTabLink.closest(".tab").index();
                        this._tabsCarousel1 = M.Carousel1.init(t[0], {
                            fullWidth: !0,
                            noWrap: !0,
                        ...
                        }), this._tabsCarousel1.set(e)
                    }
                }, {
                    key: "_teardownSwipeableTabs",
                    value: function() {
                        var t = this._tabsCarousel1.$el;
                        this._tabsCarousel1.destroy(), t.after(t.children()), t.remove()
                    }
                }, {
    ...
    function(b) {
        ...
        var e = {
            ...
            t = function(t) {
                function i(t, e) {
                    ...
                    return (n.el.M_Carousel1 = n).options = b.extend({}, i.defaults, e), n.hasMultipleSlides = 1 < n.$el.find(".carousel1-item").length, n.showIndicators = n.options.indicators && n.hasMultipleSlides, n.noWrap = n.options.noWrap || !n.hasMultipleSlides, n.pressed = !1, n.dragged = !1, n.offset = n.target = 0, n.images = [], n.itemWidth = n.$el.find(".carousel1-item").first().innerWidth(), n.itemHeight = n.$el.find(".carousel1-item").first().innerHeight(), n.dim = 2 * n.itemWidth + n.options.padding || 1, n._autoScrollBound = n._autoScroll.bind(n), n._trackBound = n._track.bind(n), n.options.fullWidth && (n.options.dist = 0, n._setCarousel1Height(), n.showIndicators && n.$el.find(".carousel1-fixed-item").addClass("with-indicators")), n.$indicators = b('<ul class="indicators"></ul>'), n.$el.find(".carousel1-item").each(function(t, e) {
                ...
                return _inherits(i, Component), _createClass(i, [{
                    key: "destroy",
                    value: function() {
                        this._removeEventHandlers(), this.el.M_Carousel1 = void 0
                    }
                }, {
                    key: "_setupEventHandlers",
                    value: function() {
                        var i = this;
                        this._handleCarousel1TapBound = this._handleCarousel1Tap.bind(this), this._handleCarousel1DragBound = this._handleCarousel1Drag.bind(this), this._handleCarousel1ReleaseBound = this._handleCarousel1Release.bind(this), this._handleCarousel1ClickBound = this._handleCarousel1Click.bind(this), void 0 !== window.ontouchstart && (this.el.addEventListener("touchstart", this._handleCarousel1TapBound), this.el.addEventListener("touchmove", this._handleCarousel1DragBound), this.el.addEventListener("touchend", this._handleCarousel1ReleaseBound)), this.el.addEventListener("mousedown", this._handleCarousel1TapBound), this.el.addEventListener("mousemove", this._handleCarousel1DragBound), this.el.addEventListener("mouseup", this._handleCarousel1ReleaseBound), this.el.addEventListener("mouseleave", this._handleCarousel1ReleaseBound), this.el.addEventListener("click", this._handleCarousel1ClickBound), this.showIndicators && this.$indicators && (this._handleIndicatorClickBound = this._handleIndicatorClick.bind(this), this.$indicators.find(".indicator-item").each(function(t, e) {
                    ...
                    value: function() {
                        var i = this;
                        void 0 !== window.ontouchstart && (this.el.removeEventListener("touchstart", this._handleCarousel1TapBound), this.el.removeEventListener("touchmove", this._handleCarousel1DragBound), this.el.removeEventListener("touchend", this._handleCarousel1ReleaseBound)), this.el.removeEventListener("mousedown", this._handleCarousel1TapBound), this.el.removeEventListener("mousemove", this._handleCarousel1DragBound), this.el.removeEventListener("mouseup", this._handleCarousel1ReleaseBound), this.el.removeEventListener("mouseleave", this._handleCarousel1ReleaseBound), this.el.removeEventListener("click", this._handleCarousel1ClickBound), this.showIndicators && this.$indicators && this.$indicators.find(".indicator-item").each(function(t, e) {
                            t.removeEventListener("click", i._handleIndicatorClickBound)
                        }), window.removeEventListener("resize", this._handleThrottledResizeBound)
                    }
                }, {
                    key: "_handleCarousel1Tap",
                    value: function(t) {
                    ...
                    key: "_handleCarousel1Click",
                    value: function(t) {
                        if (this.dragged) return t.preventDefault(), t.stopPropagation(), !1;
                        if (!this.options.fullWidth) {
                            var e = b(t.target).closest(".carousel1-item").index();
                    ...
                    key: "_handleResize",
                    value: function(t) {
                        this.options.fullWidth ? (this.itemWidth = this.$el.find(".carousel1-item").first().innerWidth(), this.imageHeight = this.$el.find(".carousel1-item.active").height(), this.dim = 2 * this.itemWidth + this.options.padding, this.offset = 2 * this.center * this.itemWidth, this.target = this.offset, this._setCarousel1Height(!0)) : this._scroll()
                    }
                }, {
                    key: "_setCarousel1Height",
                    value: function(t) {
                        var i = this,
                            e = this.$el.find(".carousel1-item.active").length ? this.$el.find(".carousel1-item.active").first() : this.$el.find(".carousel1-item").first(),
                            n = e.find("img").first();
                        if (n.length)
                            if (n[0].complete) {
                                var s = n.height();
                    ...
                    value: function(t) {
                        ...
                        if (!this.noWrap || 0 <= this.center && this.center < this.count) {
                            r = this.images[this._wrap(this.center)], b(r).hasClass("active") || (this.$el.find(".carousel1-item").removeClass("active"), r.classList.add("active"));
                        ...
                        var k = this.$el.find(".carousel1-item").eq(this._wrap(this.center));
                    ...
                    key: "getInstance",
                    value: function(t) {
                        return (t.jquery ? t[0] : t).M_Carousel1
                    }
                }, {
                    key: "defaults",
                    get: function() {
        ...
        M.Carousel1 = t, M.jQueryLoaded && M.initializeJqueryWrapper(t, "carousel1", "M_Carousel1")
    }(cash),
    function(S) {
        "use strict";
        var e = {
