...
let name = "Brandon";
let age = 28;
let address = "1969 Cedar Ave";
let greeting = `Hello, I'm ${name}. I'm ${age} and live at ${address}.`
...
*/
	...
	/*
		...
		-loop to run through list of numbers
		-compare number to the number after it
			-if current number is bigger than number after it
				-assign highest number variable current number
			-if not
