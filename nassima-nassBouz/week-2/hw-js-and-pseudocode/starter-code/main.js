...
var name = "Nassima";
var age = 22;
var address = "34 south bay rd LA.";
var greeting;
greeting = "Hello, I'm " + name + ", I'm " + age+ " years old and live in " + address;
...
console.log("************************");
console.log("Part2");
var greeting2 = `Hello,I am  ${name}  I am ${age} years old and live in ${address}`;
...
var myTable = [];
for(let i = 0; i <20; i++){
	myTable[i] = Math.floor(Math.random()*100);
	console.log("Element " + i + " of my table : " + myTable[i]);
}

var smallest = myTable[0];
var largest = myTable[0];

for(let i = 1; i <20; i++){
	if (myTable[i]<smallest){
		smallest = myTable[i];
	}
	if (myTable[i]>largest){
		largest = myTable[i];
	}
}
console.log("the smallest number of my table is :" + smallest);
console.log("the largest number of my table is :" + largest);
...
- If so, save numbers[i] in the highestNumbers variable.
