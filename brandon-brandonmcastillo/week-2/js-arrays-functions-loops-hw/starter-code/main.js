...
*/
let getDayOfWeek = function(number) {
	var day = "";
	switch (number) {
	case 1:
return day = "Monday";
...
// Have trouble figuring out
	var toppings = ["onions", "olives", "pineapples","mushrooms"]
	var addPepperoniToPizza = function(topping) {
if (toppings === topping === true)
return console.log(toppings);
} else if (toppings.findIndex(addPepperoniToPizza) === false) {
