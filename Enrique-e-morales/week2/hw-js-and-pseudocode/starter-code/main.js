...
let name = "Enrique";
let age = 25;
let address = "167 Carnation Dr.";

let greeting = `Hello, I'm ${name}, I'm ${age} years old and live on ${address}.`
...
let greeting2 = `Hello, I'm ${name}, I'm ${age} years old and live on ${address}.`
...
*/
/*
Create a for loop that will iterate from 0 to 20.
create a variable called largestNumber.
LargestNumber should be made equal to the last number on the the new array.
the new array will be a var named list[]. It will be empty.
Use the method sort() after the function to sort the number smallest to large.
*/
