...
cat.noise = function () {console.log('meow');}

let bird = {};

bird.noise = function () {console.log('chirp');}

let mouse = {};

mouse.noise = function () {console.log('squeek');}

let dog = {};

dog.noise = function () {console.log('woof');}

console.log(cat, bird, dog, mouse);
...
let animals = [cat, bird, mouse, dog];

for (var i =  animals.length - 1; i >= 0; i--) {
	  animals[i].noise();
}

console.log(animals, 'p 2');
/*
...
for (var i = animals.length - 1; i >= 0; i--) {
  animals[i]['walk'] = function () {console.log('Im walking')};
}

console.log(animals, 'p 4');
...
*/
for (var i = animals.length - 1; i >= 0; i--) {
  animals[i]['makeFriend'] = function (friend) {this['friend'] = friend}
}
