...
console.log("Hello, I'm " + name +". I'm " + age + " years old and live in " + address + ".");
...
/*
	...
	// assume the firt element is the biggest item
	// if I find something bigger consider it the new biggest item
	// Keep doing that until I reach the last item
