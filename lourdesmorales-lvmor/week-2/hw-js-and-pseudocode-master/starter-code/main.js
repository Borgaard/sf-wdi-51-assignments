...
*/
var greeting2 = `Hello, my name is ${name}, I'm ${age} and live in ${address}.`;
...
var side1 = 2;
var side2 = 4;
var side3 = Math.squrt(Math.pow(side1,2) + Math.pow(side2, 2));
console.log(side3);
/*
...
//Create a variable that equals to 0
//Get the values for all 20 numbers in a list
//Sort all numbers from smallest to largest
//Select the last number which should be the largest
//Select the first number for the smallest number
