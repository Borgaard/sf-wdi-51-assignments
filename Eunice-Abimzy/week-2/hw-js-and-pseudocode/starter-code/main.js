...
var name = "Christy";
var age = 30;
var address = "1234 Cedar Ave, San Francisco";

var greeting = "Hello, I'm " + name + " , I'm " + age + " years old and I live at " + address + ".";
...
*/
let greeting2 = `Hello, I'm ${name} , I'm ${age} years old and I live at ${address}.`
...
/*
	...
	Check the console to make sure you're getting the desired result.
*/
// hypotenuse is square root of (side1 squared+ side2 squared)
let side1;
let side2;
side1 = 4;
side2 = 5;
...
*/
console.log("First I would think of the list of numbers as an array so I would iterate through the list with a 'for loop' until the highest number remains. First, I would take the first number, compared it to the next one, save the highest in the 'highestNumber' variable. Repeat this for the length of the list");
//for
console.log("For the smallest value, the opposite would be to compare the values in pairs and save the smallest value in the 'lowestNumber' variable");
/* Bonus
