...
*/
// you can directly plug the numbers into math.max() which will return the largest number of an array but cannot return the largest number in a variable
// for the smallest you would use math.min() which does the opposite 

// otherwise a 'for' loop could be used to compare each number in an array and return the largest of the compared numbers and itterate that untell you have only 1 number left
/* Bonus
