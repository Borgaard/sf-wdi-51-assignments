...
// we grab out index.js file and book.js file here, because there is an import export chaine of exported models going
// from model file to index from index to whereever index is required.
// seed grabs from index.js
...
// methods at the end to test our code
// data that we use to create books is coming from book list above

// functions to test Book list
//==========================================================================
...
//     // create new records in databse based on the array books_list
//     db.Book.create(books_list, function(err, books){
//       if (err) { return console.log('err', err); }

//       console.log(`Created ${books.length} books`);
//       // it is important to exit the process to stop hanging up from happening
//       process.exit();
//     });
//   }
// });

// functions to test Author list
///==========================================================================
