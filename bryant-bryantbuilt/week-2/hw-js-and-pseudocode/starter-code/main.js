...
/*
Keep track of the current highest number in the sequence,
compare against the next number in the sequence,
keep the higher number of the two,
repeat until the sequence has no remaining numbers to compare,
*/
