...
var cat= new animals("Tardar Sauce", "meow");
var dog = new animals ("Billy","bark");
var bird = new animals ("Polly", "Sqawk");
var mouse = new animals ("Jerry", "Squeek");
...
var animalsArray = [cat,dog,bird,mouse];

for(i in animalsArray) {
		animalsArray[i].makeNoise();
}
