...
var name = "Person"
var age = 21
var address = "123 Fakestreet"

var greeting = "Hello, my name is " + name + ", I am " + age + " years old and live at " + address + "."
...
var greeting2 = `Hello, my name is #{name}, I am #{age} years old and live at #{address}.`
console.log(greeting);
...
// Bubble sort method would work
// store all 20 numbers in an array
// compare index 0 and index 1, if index 0 is greater than 1, swap indexes
// repeat along all of the indexes comparing neighbors and loop through until no changes are nessessary
// alternatively you could use the Math.max() method and Math.min() method respectively
