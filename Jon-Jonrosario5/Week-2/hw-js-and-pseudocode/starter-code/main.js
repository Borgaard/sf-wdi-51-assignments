...
var name = "Jon Rosario";
var age = 31;
var address = "4630 Balboa St, San Francisco,CA, 94121";

var greeting = ("I\'m " + name + " I\'m " + age + " years old and live at " + address + ".");
...
var greeting2 = `I\'m ${name}, I\'m ${age} years old and live at ${address}`;
...
// Step 1a - Take the list of numbers add it to an array and name the array
// Step 1b - Create a varible named largestNumber and set to zero.
// Step 2 - write a loop statement that loops through the array by length.
// Step 3 - Set the intial value of i to 0 and have stop point = i< array.lenth
// Step 4 - Ensure that i incrementally increases by one with each loop to check each item in the array
// Step 5 - Write an if statement, if array.[i]> largestNumber, largestNumber = array.[i]
//  Step 6 - else, continue loop
