...
// let dog = new animal('Butch','ruff');
// let cat = new animal('Felix','meow');
// let bird = new animal('Tweety','chirp');
...
var dog = new animal('Butch','ruff');
var cat = new animal('Felix','meow');
var bird = new animal('Tweety', 'chirp');
var mouse = new animal('Mickey',"Gimme Dat Cash Homie!")
...
for (var i = 0; i < animals.length; i++){
	animals[i].walk = function(){
		console.log(`${this.name} is walking, how cute.`);
		this.hunger --;
	}
}
