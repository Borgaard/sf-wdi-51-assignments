...
let name = "Ronni";
let age = "30";
let address = "123 4th St";
let greeting = "Hello, I'm " + name + ".  I'm " + age + " years old, and I live at " + address + ".";
...
const side1 = 4;
const side2 = 3;
const side3 = Math.hypot(side1, side2);
...
// Set a variable to store the larger number of each comparison pair.
// Compare the variable with the next number in the list and repeat.
// Continue until the last of the 20 numbers.
