...
let pizzaIngredients = ["olives", "sausage", "mushroom"];

let addPepperoniToPizza = function () {
	if (pizzaIngredients.indexOf("pepperoni") >= 0) {
		console.log(pizzaIngredients);
	} else {
		pizzaIngredients.push("pepperoni");
		console.log(pizzaIngredients);
	};
};
