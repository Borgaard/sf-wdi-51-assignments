...
-- San Marino, Holy See (Vatican City State)
...
WHERE city.name LIKE '%Serra%'
  AND city.countrycode != 'SMR'
  AND city.countrycode = country.code;
-- Itapecerica da Serra, Brazil; Tabo da Serra, Brazil; Serra, Brazil
...
-- She's in ____Santa Monica, USA, California_________!
