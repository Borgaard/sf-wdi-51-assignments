...
// when #box1 is clicked on, elements with class = .moto src will be set to an image
...
$('section .yellow').show();
// increased functionality if the user has clicked show blue button. This renders the yellowcolors back on the page
$('section .blue').hide();
})
...
$('#filterBlue').on('click', function () {
	$('section .yellow').hide();
	// increased functionality if the user has clicked show yellow button. This renders the blue colors back on the page
	$('section .blue').show();
})
