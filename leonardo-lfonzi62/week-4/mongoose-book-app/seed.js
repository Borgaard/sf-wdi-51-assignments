...
// going into the index.js file and bring the exported model to this file
// this is essentially requiring the database since you are grabbing the data from the index file
...
// // mongo db deleteMany method
// db.Book.deleteMany({}, function(err, books){
//   if(err) {
//     console.log('Error occurred in remove', err);
//   } else {
//     console.log('removed all books');
// // Mongo db crete method
