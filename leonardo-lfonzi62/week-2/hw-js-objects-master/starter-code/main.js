...
for (var i = 0; i < animals.length; i++) {
 	animals[i].hunger = 10;
 	console.log(`${animals[i].animalType} hunger is ${animals[i].hunger}`);
 }
/*
...
// function walk () {
// 	   return
// 	   `${this.animalType} took a walk!`;
// }

for (var i = 0; i < animals.length; i++) {
 	animals[i].walk = function () {
 	return(`${this.animalType} took a walk!`)};
 	console.log(animals[i].walk());
 }
/*
...
*/
for (var i = 0; i < animals.length; i++)  {
animals[i].makeFriend = function (name) {
	this.friends = name;
}
}
/* BONUS
