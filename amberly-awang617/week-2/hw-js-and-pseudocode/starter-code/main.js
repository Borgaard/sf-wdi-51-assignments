...
let name = "Amberly";
let age = 22;
let address = "100 Main Street"
let greeting = "Hello, I'm " + name + ", I'm " + age + " and live on " + address + ".";
...
*/
let greeting2 = `Hello, I'm ${name}, I'm ${age} and live on ${address}.`;
...
console.log(`Side 1 is ${side1}. Side 2 is ${side2}. So side 3 is ${side3}`);
