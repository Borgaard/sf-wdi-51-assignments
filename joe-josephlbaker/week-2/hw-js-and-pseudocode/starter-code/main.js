...
let greeting = `Hello, I'm ${name}, I'm ${age} years old and live at ${address}.`;
...
CREATE A VARIABLE CALLED LARGEST NUMBER AND SET IT EQUAL TO 0
GO THROUGH THE ARRAY AND...
  IF THE FIRST NUMBER IS BIGGER THAN 0
    SET LARGEST NUMBER VARIBALE EQUAL TO THAT NUMBER
  IF THE NEXT NUMBER IS BIGGER THAN THE LARGEST NUMBER VARIABLE
    SET THE LARGEST NUMBER VARIABLE EQUAL TO THAT NUMBER
...
CREATE A VARIABLE CALLED SMALLEST NUMBER AND SET IT EQUAL TO THE FIRST NUMBER IN THE ARRAY
GO THROUGH THE ARRAY AND...
  IF THE SECOND NUMBER IS SMALLER THAN SMALLEST NUMBER
    SET SMALLEST NUMBER VARIABLE EQUAL TO THAT NUMBER
  IF THE NEXT NUMBER IS SMALLER THAN THE SMALLEST NUMBER VARIABLE
    SET THE SMALLEST NUMBER VARIABLE EQUAL TO THAT NUMBER
CONTINUE UNTIL YOU REACH THE END OF THE ARRAY
...
console.log(`The highest number is ${highestNumber(numbers)}`);
